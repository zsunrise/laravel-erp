        ...
        <div class="page-card">
            <div class="page-header">
                <div class="header-left">
                    <Folder :size="24" class="header-icon" />
                    ...
                    <el-col :span="12">
                        <div class="tree-container">
                            ...
                            <div class="tree-content" v-loading="loading">
                                    ...
                                    <template #default="{ node, data }">
                                        <span class="tree-node">
                                            ...
                                            <span class="tree-node-actions">
                                                <el-button type="primary" link size="small" @click.stop="handleAddChild(data)" class="action-btn">
                                                    添加子分类
                                                </el-button>
                                ...
                                <el-empty v-else-if="treeData.length === 0" description="暂无分类数据" :image-size="120">
                                    <el-button type="primary" @click="handleAdd">创建第一个分类</el-button>
                                </el-empty>
                                <el-empty v-else description="未找到匹配的分类" :image-size="100" />
                            </div>
                        </div>
                    </el-col>
                    <el-col :span="12">
                            ...
                            <div class="detail-content" v-if="currentCategory">
                                ...
                                <el-descriptions :column="1" border class="modern-descriptions">
                                    <el-descriptions-item label="分类名称">
                                        <span class="detail-value highlight">{{ currentCategory.name }}</span>
                                    </el-descriptions-item>
                                    <el-descriptions-item label="分类编码">
                                        <el-tag type="info" size="small" effect="plain">{{ currentCategory.code }}</el-tag>
                                    </el-descriptions-item>
                                    <el-descriptions-item label="父分类">
                                        <span class="detail-value">{{ currentCategory.parent?.name || '无' }}</span>
                                    </el-descriptions-item>
                                    <el-descriptions-item label="排序">
                                        <span class="detail-value">{{ currentCategory.sort }}</span>
                                    </el-descriptions-item>
                                    <el-descriptions-item label="状态">
                                        <el-tag :type="currentCategory.is_active ? 'success' : 'danger'" effect="dark" round>
                                            {{ currentCategory.is_active ? '启用' : '禁用' }}
                                        </el-tag>
                                    </el-descriptions-item>
                                    <el-descriptions-item label="描述">
                                        <span class="detail-value description-text">{{ currentCategory.description || '-' }}</span>
                                    </el-descriptions-item>
                                </el-descriptions>
                            </div>
                            <el-empty v-else description="请选择一个分类查看详情" :image-size="100">
                                <template #image>
                                    <Folder :size="80" style="opacity: 0.3;" />
                                </template>
                            </el-empty>
                        </div>
                    </el-col>
...
import { Plus, Folder, Search } from 'lucide-vue-next';
