...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('system-configs/key/{key}', [SystemConfigController::class, 'getByKey']);
    ...
    Route::post('inventory-stocktakes', [InventoryController::class, 'createStocktake']);
    Route::get('inventory-stocktakes/{id}', [InventoryController::class, 'showStocktake']);
    Route::post('inventory-stocktakes/{id}/items', [InventoryController::class, 'addStocktakeItem']);
    Route::post('inventory-stocktakes/{id}/complete', [InventoryController::class, 'completeStocktake']);
